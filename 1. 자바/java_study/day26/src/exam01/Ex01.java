...
public class Ex01 {
    public static void main(String[] args){
        ...
        //Map<String, List<Student>> student2 = students
        //    .stream().collect(Collectors.groupingBy(s -> s.getClass());

        Map<String, List<Student>> student2 = students
                .stream().collect(Collectors.groupingBy(Student::getBan));

        List<Student> ban1 = student2.get("1반");
        List<Student> ban2 = student2.get("2반");
        List<Student> ban3 = student2.get("3반");
